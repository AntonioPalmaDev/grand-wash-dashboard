  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="glass-card p-6 rounded-xl space-y-4 border border-white/5">
        <div>
          <h2 className="text-lg font-semibold">Taxas do Sistema</h2>
          <p className="text-sm text-muted-foreground">
            Configure as taxas padrões utilizadas nas operações.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({ ...formData, taxaPF: Number(e.target.value) })
              }
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({ ...formData, taxaPJ: Number(e.target.value) })
              }
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  taxaMaquina: Number(e.target.value),
                })
              }
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  taxaLiquida: Number(e.target.value),
                })
              }
